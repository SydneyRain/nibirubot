...
module.exports = class extends Command {
    ...
    async enable(msg) {
        ...
        else { return msg.send('Usage: ``starboard enable [channel]`` - Enables a Starboard channel.\nExample: ``starboard enable #starboard`` - Enables the Starboard on the channel "#starboard"'); }
